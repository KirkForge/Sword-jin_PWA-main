#!/usr/bin/env python3
"""
generate_more_battle_bgm.py
Generate additional battle/dungeon/tension BGM loops for Swordjin using MiniMax music-2.6.
...
TRACKS = [
    {
        "name": "bgm_tension_low",
        "prompt": "Tense dark fantasy exploration music, low drones, distant percussion, lurking danger, building suspense, loopable instrumental",
    },
    {
        "name": "bgm_skirmish",
        "prompt": "Fast dark fantasy skirmish battle music, driving strings, sharp brass stabs, clashing swords energy, loopable instrumental",
    },
    {
        "name": "bgm_boss_reveal",
        "prompt": "Epic dark fantasy boss reveal music, massive brass, ominous choir, slow terrifying build, loopable instrumental",
    },
    {
        "name": "bgm_dungeon_descent",
        "prompt": "Dark fantasy dungeon exploration music, deep cellos, stone echo, subtle tribal drums, oppressive atmosphere, loopable instrumental",
    },
    {
        "name": "bgm_frenzy",
        "prompt": "Frantic dark fantasy combat music, breakneck strings, pounding war drums, desperate energy, loopable instrumental",
    },
    {
        "name": "bgm_phantom_chase",
        "prompt": "Supernatural chase music for dark fantasy RPG, ghostly strings, heartbeat drums, cold dread, loopable instrumental",
    },
    {
        "name": "bgm_heroic_stand",
        "prompt": "Heroic last-stand battle music for dark fantasy RPG, bold brass, choir, determined percussion, loopable instrumental",
    },
    {
        "name": "bgm_tear_corruption",
        "prompt": "Corrupted cosmic horror music for dark fantasy RPG, unstable dissonant choir, crimson ambient pads, otherworldly dread, loopable instrumental",
    },
]
