#!/usr/bin/env python3
"""
generate_more_exploration_bgm.py
Generate additional exploration/region BGM loops for Swordjin using MiniMax music-2.6.
...
TRACKS = [
    {
        "name": "bgm_marshlands",
        "prompt": "Ambient dark fantasy marshlands music, slow drones, distant croaking, misty pads, eerie exploration, loopable instrumental",
    },
    {
        "name": "bgm_frozen_waste",
        "prompt": "Ambient frozen wasteland music for dark fantasy RPG, cold wind, glassy chimes, desolate solitude, loopable instrumental",
    },
    {
        "name": "bgm_sunken_realm",
        "prompt": "Ambient underwater sunken realm music for dark fantasy RPG, deep sonorous drones, echoing bells, mysterious aquatic atmosphere, loopable instrumental",
    },
    {
        "name": "bgm_crimson_fields",
        "prompt": "Ambient dark fantasy battlefield-aftermath music, low strings, distant crows, sorrowful exploration, loopable instrumental",
    },
    {
        "name": "bgm_witching_hour",
        "prompt": "Ambient witching hour music for dark fantasy RPG, subtle harp, hooting owls, uneasy magical night, loopable instrumental",
    },
    {
        "name": "bgm_abandoned_village",
        "prompt": "Ambient abandoned village music for dark fantasy RPG, creaking wood, lonely violin, haunted emptiness, loopable instrumental",
    },
    {
        "name": "bgm_crystal_caverns",
        "prompt": "Ambient crystal cavern music for dark fantasy RPG, glassy pads, resonant chimes, shimmering underground beauty, loopable instrumental",
    },
    {
        "name": "bgm_hollow_throne",
        "prompt": "Ambient dark fantasy throne room music, solemn low brass, ghostly echoes, regal decay, loopable instrumental",
    },
]
